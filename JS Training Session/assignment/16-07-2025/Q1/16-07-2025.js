...
let handleSubmit = (e) => {
  ...
  let confirm_userpassword = document.getElementById(
  ...
  if (!isPasswordStrong(userpassword)) {
    alert(
      "Password must contain atleast 1 capital, 1 small, 1 symbol and atleast 1number and atleast length of password should be 8."
    );
    return false;
  }
